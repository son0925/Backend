package org.aba2.calendar.config.objectmapper;
...
public class ObjectMapperConfig {
    ...
    /**
     * Spring에서는 기본적으로 Jackson의 ObjectMapper를 사용해 JSON 직렬화 및 역직렬화 작업을 수행
     * 만약 애플리케이션 컨텍스트에 ObjectMapper 빈이 등록되어 있으면 Spring이 해당 빈을 사용
     * 이 클래스는 Spring에서 사용할 커스터마이징된 ObjectMapper 빈을 생성하여 JSON 변환 로직을 조정함
     *
     * 현재는 snake_case에 대한 설정
     */
